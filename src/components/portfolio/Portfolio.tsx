...
const iyadPhotoSrc = typeof iyadPhoto === "string" ? iyadPhoto : iyadPhoto.src;
const awsLogoSrc = typeof awsLogo === "string" ? awsLogo : awsLogo.src;
...
function Hero() {
  ...
  const ctxValue = useMemo(() => ({ mouseX, mouseY, active, bubbles }), [mouseX, mouseY, active]);
    ...
    <section id="home" className="relative overflow-hidden pt-20 pb-28 md:pt-28 md:pb-40">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 md:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          >
            <span className="size-1.5 rounded-full bg-emerald-400" /> Available for web revamp
            projects · Tampa, FL
          </motion.div>
          <motion.h1
          ...
          >
            Building <span className="text-gradient">cleaner, faster, more credible</span> websites
          ...
          >
            I'm Iyad — a B.S. Cloud Computing student at WGU with an A.A. in Computer Engineering
            from HCC, and the founder of PageFoundry. I help small businesses replace outdated
            websites with fast, mobile-first sites that actually convert.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <MouseContext.Provider value={ctxValue}>
            <motion.div
              ...
              style={{
                background:
                  "conic-gradient(from 0deg, oklch(0.72 0.17 245 / 0.6), oklch(0.78 0.13 200 / 0.4), oklch(0.65 0.21 295 / 0.6), oklch(0.72 0.17 245 / 0.6))",
                filter: "blur(20px)",
              }}
              animate={{ rotate: 360 }}
        ...
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr]">
          <div className="glass rounded-2xl p-7 text-[15px] leading-relaxed text-muted-foreground">
            <p>
              ...
              and an IB Diploma from C. Leon King High School. My background spans technical
              support, database maintenance, and systems auditing, and I'm proficient in Python,
              Java, and Linux environments.
            </p>
            <p className="mt-4">
              On top of that I run <span className="text-foreground font-medium">PageFoundry</span>{" "}
              — a web studio focused on giving small businesses sites that look modern, load fast,
              and earn trust at first glance. I hold the AWS Certified Cloud Practitioner and the
              CompTIA trifecta (A+, Network+, Security+), plus Cloud+, Project+, ITIL, and LPI Linux
              Essentials.
            </p>
          </div>
...
const SERVICES = [
  {
    ...
    desc: "Turn an outdated site into a modern, credible one in 2–3 weeks.",
  },
  {
    icon: MapPin,
    title: "Local Landing Pages",
    desc: "City- and service-specific pages built to rank and convert.",
  },
  {
    icon: Smartphone,
    title: "Mobile Optimization",
    desc: "Sites that feel native on phones — where 70% of your traffic is.",
  },
  {
    icon: Wrench,
    title: "Maintenance & Care",
    desc: "Ongoing updates, backups, uptime checks, content edits.",
  },
  {
    icon: Search,
    title: "SEO & Performance",
    desc: "Clean markup, Lighthouse scores in the 90s, real keyword strategy.",
  },
  {
    icon: FormInput,
    title: "Forms & Lead Capture",
    desc: "Contact forms, quote requests, and CRM-ready lead pipelines.",
  },
];
...
function WhyMe() {
  const reasons = [
    {
      icon: ShieldCheck,
      t: "No template factories",
      d: "Every site is custom-built, not stitched from a marketplace theme.",
    },
    {
      icon: Gauge,
      t: "Performance-first",
      d: "Lighthouse 90+ scores, sub-2s loads, mobile-optimized by default.",
    },
    {
      icon: Cloud,
      t: "Cloud-native foundations",
      d: "Hosting, DNS, SSL, and analytics set up the right way — not by a salesperson.",
    },
    {
      icon: ArrowRight,
      t: "Direct line",
      d: "You text me, not a ticket queue. Edits and updates happen the same week.",
    },
  ];
  return (
    <section className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          kicker="05 · Why Work With Me"
          title="Built for businesses that are tired of being burned."
        />
...
const PRICING = [
  ...
  },
  {
    ...
    items: [
      "Up to 10 pages",
      "Custom design + brand polish",
      "On-page SEO + Lighthouse 90+",
        ...
        <div className="glass-strong relative overflow-hidden rounded-3xl p-10 text-center md:p-16">
          ...
          <div className="relative">
            <h2 className="text-3xl font-semibold md:text-5xl">
              Let's make your site the one customers trust.
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Email me a link to your current site and I'll send back a free 5-minute audit with
              what I'd change first.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <a
                href={`mailto:${EMAIL}`}
                className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:scale-[1.02] glow-primary"
              >
                <Mail className="size-4" /> {EMAIL}
              </a>
              <a
                href={PHONE_HREF}
                className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm font-medium hover:border-primary/50"
              >
